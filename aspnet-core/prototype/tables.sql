...
CREATE TABLE `material_requisition` (
  ...
  `C_APPLICANT_NAME` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '申请人描述',
  ...
  `C_ORGANIZATION_UNIT_NAME` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '申请部门描述',
  ...
  `C_ISSUE_STORAGE_LOCATION` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '发货库存地点',
...
CREATE TABLE `paper_machine_relation_map` (
  ...
  `C_MES_LGPLA` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'MES仓位',
  `C_LGTYP` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仓储类型',
